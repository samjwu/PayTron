          ...
          {kingdoms.length === 0 ?
            ...
            >
              <div class="d-flex w-100 justify-content-between">
                <h5 class="mb-1">Loading other content creator pages...</h5>
              </div>
              <p class="mb-1">&nbsp;</p>
            </div>
            :
            ...
            {kingdoms.map((kingdom, index) => {
              ...
              if (kingdom.error) {
                return (
                  ...
                  >
                    <div class="d-flex w-100 justify-content-between">
                      <h5 class="mb-1">{ kingdom.ruler.username }'s page can't be reached</h5>
                    </div>
                    <p class="mb-1">Is the site { planet } down?</p>
                  </div>
                )
              } else {
                return (
